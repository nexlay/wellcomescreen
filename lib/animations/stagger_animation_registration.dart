...
import 'package:projects/components/registration_layout.dart';


class StaggerAnimationRegistration extends StatelessWidget {
  final Function showScreen;
  StaggerAnimationRegistration({Key? key, required this.controller, required this.showScreen})
      :
  ...
  Widget _buildAnimation(BuildContext context, Widget? child) {
   return RegistrationCardLayout(elevation, opacityText1, opacityText2, opacityText3, cardOpacity, showScreen);
  }
